...
<p style="border:1px solid red;border-radius:10px;padding:5px"><b>B) O código avalia a expressão booleana, imprime o resultado `true`, calcula a soma dos números de 1 a 5 e imprime o resultado no console.</b></p>
...
<p style="border:1px solid red;border-radius:10px;padding:5px"><b>B) A saída de calcularOrcamento() seria: 'Seu saldo é negativo de -1050.' e a de calcularOrcamento2() seria: 'Seu saldo é negativo de -100.'</b></p>
...
<p style="border:1px solid red;border-radius:10px;padding:5px"><b>D) O código verifica se o número é par, se é divisível por 3 ou se é ímpar. Se for par, exibe a mensagem "O número é par!". Se for divisível por 3 (e não for par), exibe a mensagem "O número é divisível por 3!". Se for ímpar (e não for divisível por 3), exibe a mensagem "O número é ímpar e não é divisível por 3!".</b></p>
...
<p style="border:1px solid red;border-radius:10px;padding:5px"><b>D)
...
<p style="border:1px solid red;border-radius:10px;padding:5px"><b>B) Preload -> Create -> Update</b></p>
...
<p style="border:1px solid red;border-radius:10px;padding:5px"><b>B) Simular interações físicas realistas, como colisões e movimentos, em jogos 2D.</b></p>
...
**RESPOSTA:**
```
Função simular_desempenho(distancia, velocidade_inicial, aceleracao, velocidade_maxima, tempo_maximo):
    tempo = 0
    ...
    Enquanto verdadeiro:
        ...
        Se tempo >= tempo_maximo:
            Retornar "Tempo excedido"  
        
        tempo += 1


tempo_total = simular_desempenho(100, 0, 2, 30, 60)
Se tempo_total != "Tempo excedido":
    Imprimir("O carro completou a corrida em", tempo_total, "minutos.")
Senão:
    Imprimir("O carro não conseguiu completar a corrida dentro do tempo limite.")
